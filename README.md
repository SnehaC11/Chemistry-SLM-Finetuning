...
Highlights:
•	Custom dataset: 7,161 curated chemistry Q&A pairs spanning physical, organic, and inorganic chemistry
•	Parameter-efficient fine-tuning: LoRA adapters used on both models to keep training lightweight and reproducible on limited compute
•	Head-to-head comparison: Same dataset, same evaluation pipeline, applied consistently across both architectures
•	Quantitative evaluation: F1 score and perplexity used to benchmark answer correctness and generation fluency, not just qualitative inspection
